    ...
    <div class="row">
      ...
      <div class="col-lg-7 col-md-7 col-sm-7 col-12">
        <div class="row metroBoxArea">
          ...
          <div class="col-lg-2 col-md-2 col-sm-4 col-12"> <a href="perches.html" class="metroBox d-flex align-items-center justify-content-center wow zoomIn" style="background: #d64f35;"><span>Purchase</span><img src="{{ url('assets/admin/new/images/icon/6.svg') }}" alt=""/></a> </div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-4 col-12"> <a href="#" class="metroBox d-flex align-items-center justify-content-center wow zoomIn" style="background: #203966;"><span>POS</span><img src="{{ url('assets/admin/new/images/icon/8.svg') }}" alt=""/></a> </div>
