...
<head>
    ...
    <title>Laravel</title>
    <link rel="icon" type="image/x-icon" href="https://www.w3schools.com/images/w3schools_logo_436_2.png">
    <!-- Fonts -->
...
<body class="hold-transition sidebar-mini layout-fixed ">
    ...
    <x-alert type="danger" message="Hello World" xlink="exclamation-triangle-fill" />
    <i class="fab fa-accessible-icon"></i>
    <select name="" id="" multiple="multiple" class="form-control">
        <option value="">sdsd</option>
        <option value="">sdsd</option>
        <option value="">sdsd</option>
    </select>
    <textarea name="" id="" cols="30" rows="10" class="ck-editor"></textarea>
    ...
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                <img src="{{ asset('assets/admin-lte/img/user1-128x128.jpg') }}" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                <img src="{{ asset('assets/admin-lte/img/user8-128x128.jpg') }}" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                <img src="{{ asset('assets/admin-lte/img/user3-128x128.jpg') }}" alt="User Avatar"
                                    class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ asset('assets/admin-lte/img/AdminLTELogo.png') }}" alt="AdminLTE Logo"
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <img class="direct-chat-img"
                                                src="{{ asset('assets/admin-lte/img/user1-128x128.jpg') }}"
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <img class="direct-chat-img"
                                                src="{{ asset('assets/admin-lte/img/user3-128x128.jpg') }}"
                                                alt="message user image">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ asset('assets/admin-lte/img/user7-128x128.jpg') }}"
                                                        alt="User Avatar">
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Sarah Doe
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ asset('assets/admin-lte/img/user5-128x128.jpg') }}"
                                                        alt="User Avatar">
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Nora S. Vans
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ asset('assets/admin-lte/img/user6-128x128.jpg') }}"
                                                        alt="User Avatar">
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            John K.
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ asset('assets/admin-lte/img/user8-128x128.jpg') }}"
                                                        alt="User Avatar">
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Kenneth M.
