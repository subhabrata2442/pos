...
<div class="col-lg-8 col-md-8">
  ...
  <div class="col-lg-4 col-md-4">
    ...
    <div class="sidebar-widget text-center">
      <ul class="row">
        <li class="col-3"><a href="jsvascript:;" data-bs-toggle="modal" data-bs-target="#modal-1"><span><i class="fas fa-ticket-alt"></i></span>Apply<br>Coupon</a></li>
        ...
        <div class="holdBillList">
          <ul>
            <li>
              ...
              <div class="print mt-2"><button class="btn btn-info"><i class="fas fa-print"></i> print</button></div>
            </li>
            <li>
              <a href="#">
                <div class="d-flex justify-content-between w-100">
