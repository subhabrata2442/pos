                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control admin-input" id="supplier_company_address" name="supplier_company_address" value="{{ old('address', $data['supplier']->address) }}" required autocomplete="off">
          ...
          <div class="span10 offset1">
            <div class="well">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-body greybg">
                    <h5 class="hk-sec-title">Supplier Contact Details <a href="javascript:;" id="contactplus"><i class="fa fa-plus"></i></a></h5>
                    <div id="repeat_contact">
                    @if(count($data['supplierContact'])>0)
                    @php($count=0)
                    @foreach($data['supplierContact'] as $cRow)
                      <div class="row" id="new_contact_{{$count}}">
                        <div class="col-md-1">
                          <label class="form-label"></label>
                          <select id="salutation_id" name="salutation_id[]" class="form-control form-inputtext">
                            <option value="1" @if ($cRow->salutation_id == 1) selected @endif>Mr.</option>
                            <option value="2" @if ($cRow->salutation_id == 1) selected @endif>Miss</option>
                            <option value="3" @if ($cRow->salutation_id == 1) selected @endif>Ms.</option>
                            <option value="4" @if ($cRow->salutation_id == 1) selected @endif>Dear.</option>
                          </select>
                        </div>
                        <div class="col-md-2">
                          <label class="form-label">First Name</label>
                          <input type="text" maxlength="100" name="supplier_contact_firstname[]" value="{{$cRow->contact_firstname}}" class="form-control form-inputtext" placeholder="" >
                        </div>
                        <div class="col-md-2">
                          <label class="form-label">Last Name</label>
                          <input type="text" maxlength="100" name="supplier_contact_lastname[]" value="{{$cRow->contact_lastname}}" class="form-control form-inputtext" placeholder="" >
                        </div>
                        <div class="col-md-2">
                          <label class="form-label">Designation</label>
                          <input type="text" maxlength="100" name="supplier_contact_designation[]" value="{{$cRow->contact_designation}}" class="form-control form-inputtext" placeholder="" >
                        </div>
                        <div class="col-md-2">
                          <label class="form-label">Email Id</label>
                          <input type="text" maxlength="100" name="supplier_contact_email_id[]" value="{{$cRow->contact_email}}" class="form-control form-inputtext" placeholder="" >
                        </div>
                        <div class="col-md-2">
                          <label class="form-label">Date of Birth</label>
                          <input type="text" maxlength="100" name="supplier_date_of_birth[]" value="{{$cRow->date_of_birth}}" class="form-control form-inputtext" placeholder="" >
                        </div>
                        <div class="col-md-2">
                          <label class="form-label">Mobile No.</label>
                          <input type="text" maxlength="100" name="supplier_contact_mobile_no[]" value="{{$cRow->contact_mobile}}" class="form-control form-inputtext" placeholder="" >
                        </div>
                        <div class="col-md-2">
                          <label class="form-label">Whatsapp No.</label>
                          <input type="text" maxlength="100" name="supplier_whatsapp_no[]"  value="{{$cRow->whatsapp_no}}" class="form-control form-inputtext" placeholder="" >
                        </div>
                        <input type="hidden" name="supplier_contact_details_id[]"  value="{{$cRow->id}}">
                        @if($count!=0)
                        <a href="javascript:;" id="remove_contact_{{$count}}" onclick="remove_contact_row('{{$count}}');" data-id='{{$count}}'>X</a>
                        @endif
                      </div>
                     @php($count++)
                     @endforeach
