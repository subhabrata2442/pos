    ...
    <div class="row">
      ...
      <div class="col-lg-7 col-md-7 col-sm-7 col-12">
        <div class="row metroBoxArea">
          ...
          <div class="col-lg-3 col-md-3 col-sm-4 col-12"> <a href="{{ route('admin.report.inventory') }}" class="metroBox d-flex align-items-center justify-content-center wow zoomIn" style="background: #2e7fe6;"><span>Inventory</span><img src="{{ url('assets/admin/new/images/icon/3.svg') }}" alt=""/></a> </div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-4 col-12"> <a href="{{ route('admin.report.sales.product') }}" class="metroBox d-flex align-items-center justify-content-center wow zoomIn" style="background: #f76ce1;"><span>Sales Report</span><img src="{{ url('assets/admin/new/images/icon/5.svg') }}" alt=""/></a> </div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-4 col-12"> <a href="{{ route('admin.report.purchase') }}" class="metroBox d-flex align-items-center justify-content-center wow zoomIn" style="background: #e08300;"><span>Purchase Report</span><img src="{{ url('assets/admin/new/images/icon/11.svg') }}" alt=""/></a> </div>
