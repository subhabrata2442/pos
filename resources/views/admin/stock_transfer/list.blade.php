      ...
      <div class="modal-body">
        <div class="applyCouponBox">
          ...
          <input type="hidden" id="transfer_to" name="transfer_to" value="w" />
            <div class="mb-3">
              <label for="" class="form-label">Warehouse qty (Prev Stock:<span id="prev_w_qty_label"></span>)</label>
              <input type="number" class="form-control number" name="w_qty" id="w_qty-input" autocomplete="off">
            </div>
            <div class="mb-3">
              <label for="" class="form-label">Counter qty (Prev Stock:<span id="prev_c_qty_label"></span>)</label>
              <input type="number" class="form-control number" name="c_qty" id="c_qty-input" autocomplete="off">
            </div>
