...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; color:#333; font-size:13px;">
  	...
  	<td>
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td style="padding:8px 7px; font-weight:bold; font-size:14px; text-align:center;">:</td>
            <td style="padding:8px 7px;font-size:13px; font-weight:normal; text-align:right;">{{$invoice_details['gstin']}}</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
    	...
    	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:#777 1px solid;">
          ...
          @if (count($items) > 0)
              @forelse ($items as $item)
                <tr>
                    <td style="text-align:left;padding:8px 7px; border-bottom:#ccc 1px solid;">{{$item['particulars']}}</td>
                    ...
                    <td style="text-align:center;padding:8px 7px; border-bottom:#ccc 1px solid;">{{$item['offer_price']}}</td>
                    <td style="text-align:center;padding:8px 7px; border-bottom:#ccc 1px solid;">{{$item['disc_price']}}</td>
              ...
              @endforelse
                <tr>
                    ...
                    <td colspan="3" style="text-align:left;padding:8px 7px;font-weight:bold; font-size:13px;">{{$total['total_qty']}}</td>
                    <td style="text-align:center;padding:8px 7px; font-weight:bold; font-size:13px;">{{$total['total_disc']}}</td>
  ...
  <tr>
  	<td>
        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border:#777 1px solid;">
          <tr>
  ...
  <tr>
  	<td style="padding:15px 5px;font-weight:bold; text-align:center; font-size:16px;">Your Savings on MRP : Rs. {{$total['total_disc']}}</td>
  </tr>
  <tr>
