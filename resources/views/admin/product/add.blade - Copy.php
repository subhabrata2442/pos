...
<div class="row">
  <div class="col-12">
    <div class="card">
      <form method="post" action="{{ route('admin.product.add') }}" class="needs-validation" novalidate
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control admin-input" id="default_purchase_price"
                                    name="default_purchase_price" value="{{ old('default_purchase_price') }}" required
                                    autocomplete="off">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="number" class="form-control admin-input" id="purchase_tax_rate"
                                    name="purchase_tax_rate" value="{{ old('purchase_tax_rate') }}" required
                                    autocomplete="off">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="number" class="form-control admin-input" id="min_order_qty"
                                    name="min_order_qty" value="{{ old('min_order_qty') }}" required autocomplete="off">
              @error('min_order_qty')
              <div class="error admin-error">{{ $message }}</div>
              @enderror </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control admin-input" id="pack_size" name="pack_size"
                                    value="{{ old('pack_size') }}" required autocomplete="off">
              @error('pack_size')
              <div class="error admin-error">{{ $message }}</div>
              @enderror </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <textarea name="product_desc" rows="3" id="product_desc" class="form-control admin-textarea" required>{{ old('product_desc') }}</textarea>
              @error('product_desc')
              <div class="error admin-error">{{ $message }}</div>
              @enderror </div>
          </div>
                    ...
                    <tbody>
                      <tr>
                        <td><div class="select-two">
                            <select id="supp_code" class="form-control admin-input">
                              ...
                              <option value="{{ $value->id }}"
                                                                        data-sup_name="{{ $value->sup_name }}"> {{ $value->sup_code }}</option>
                        ...
                        <td><input type="text" id="supp_product_code"
                                                            class="form-control admin-input"></td>
