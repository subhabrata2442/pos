    ...
    <div class="card">
      ...
      <div class="table-responsive custom-table">
        <table id="" class="table table-bordered text-nowrap">
			...
			<tbody>
				@forelse ($data['bar_products'] as $product_size)
				<tr>
					<td>{{@$product_size->product->product_name}}</td>
					<td>{{@$product_size->product->category->name}}</td>
					<td>{{@$product_size->product->subcategory->name}}</td>
					<td align="center">{{-- {{@$product_size->size->name}} --}}
                        <table>
                            @forelse (@$product_size->barProductSizePrice as $size_price)
                            <tr>
                                <td align="center">{{@$size_price->size->name}}</td>
                            </tr>
                            @empty
					...
					<td align="center">
                        <table>
                            @forelse (@$product_size->barProductSizePrice as $size_price)
                            <tr>
                                <td align="center">{{number_format(@$size_price->product_mrp,2)}}</td>
                            </tr>
                            @empty
		...
		{{ $data['bar_products']->appends($_GET)->links() }}
      </div>
    </div>
  </div>
</div>
