...
<div class="row">
  <div class="col-12">
    <form method="post" action="{{ route('admin.restaurant.table.add') }}" class="needs-validation" novalidate enctype="multipart/form-data">
      @csrf
      <div class="card">
        <div class="row">
          <x-alert />
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control admin-input" id="title" name="title" value="{{ old('title') }}" required autocomplete="off" placeholder="Enter Floor/Room Name">
              @error('title')
